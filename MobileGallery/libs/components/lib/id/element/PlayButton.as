...
package id.element
{
	 ...
	 */
	public class PlayButton extends TouchComponent
	{
		...
		override protected function updateUI():void
		{
			...
			//triangle.graphics.lineStyle(1,_style.buttonOutlineColor);
			triangle.graphics.beginFill(_style.buttonSymbolColor);
			triangle.graphics.moveTo(0, 0);
			triangle.graphics.lineTo(triangleHeight, buttonRadius/2);
			triangle.graphics.lineTo(0, buttonRadius);
			triangle.graphics.lineTo(0, 0);
			
			triangle.x=(0-triangle.width)/2+3;
