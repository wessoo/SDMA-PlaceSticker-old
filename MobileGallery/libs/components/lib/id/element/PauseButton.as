...
package id.element
{
	 ...
	 */
	public class PauseButton extends TouchComponent
	{
		...
		override protected function updateUI():void
		{
			...
			bar1.graphics.clear();
			bar1.graphics.beginFill(_style.buttonSymbolColor,1);
			bar1.graphics.drawRect(0,0,4,buttonRadius);
			bar1.graphics.endFill();
			
			bar2.graphics.clear();
			bar2.graphics.beginFill(_style.buttonSymbolColor,1);
			bar2.graphics.drawRect(0,0,4,buttonRadius);
			bar2.graphics.endFill();
			
			bar1.x=0-bar1.width-2;
			bar1.y=(0-buttonRadius)/2;
			
			bar2.x=2;
			bar2.y=(0-buttonRadius)/2;
		}
