...
package id.ui
{
	...
	public class SplashScreen extends Sprite
	{
		...
		{
			_matrix = new Matrix();
			_matrix.createGradientBox(199, 199, 90 / 180 * Math.PI, 0, 0);
		...
		private function gridLoader_Error(e:Event=null)
		{			
			grid.graphics.clear();
		...
		private function logoLoader_Error(e:Event=null)
		{
			logo.graphics.clear();
		...
		private function titleLoader_Error(e:Event=null)
		{			
